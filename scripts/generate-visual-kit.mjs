...
| 页面 | 图片位置 | 手机布局 |
|---|---|---|
| 首页 | 一组桌面／手机全屏背景；四个居中Logo | 独立长屏背景；Logo同源 |
...
轮播第2、3组、个人肖像和额外活动图不列入本轮必交清单。先确认一组首页构图。旧PDF尺寸表已废止，不再用于新素材。
...
audit=audit.replace(/3\. \*\*Press 真实性\*\*[^\n]*/, '3. **Press 真实性**：已改成3个中性图片框，旧活动占位图与未经确认的参与关系不再展示；仍需提交真实标题、日期、参与方式与图片授权。')
 .replace(/4\. \*\*活动标识\*\*[^\n]*/, '4. **活动标识**：首页不再展示旧的简化活动标识；如恢复活动名称或标识，需确认参与方式与素材来源。')
