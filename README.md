...
| 09-22 · 流光循环 | 流光取消阶段门控，改为全程不停循环、强度290%；时长改为0/10/2/4/2/5，共23秒 |

详细记录：[需求与实施时间线](docs/project-log/2026-09-12-to-22.md) · [流光循环](docs/project-log/2026-09-22-flow-loop.md) · [Hero参数历史](docs/project-log/hero-parameters.md) · [Git历史](docs/project-log/git-history.md)。

## 当前确认值

手机X **390px**；桌面X **650px**；固定2876:1580比例、中心锁定、窗口裁切；噪点12% / 0.9px。六段时长 **0 / 10 / 2 / 4 / 2 / 5秒**，共23秒。宽柔光与细弧边高光**不分阶段、全程不停循环**，强度290%、速度1.00×。唯一参数来源：[hero-light.ts](src/config/hero-light.ts)。
