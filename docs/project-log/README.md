...
6. [2026-09-22 · 退场改为开场倒放](2026-09-22-loop-seam.md)：25 秒时长、流光 0.55×，首尾同帧无缝循环；替代时间线第 9 条的扩散退场。
7. [Hero 参数历史](hero-parameters.md)：每轮视觉调整及当前确认值。
8. [Git 提交快照](git-history.md)：截至上一实现提交 `406e803` 的完整可达提交记录；此后的变更以 Git 实时日志为准。
9. 按任务查阅 [项目规则](../../PROJECT_RULES.md)、[Hero 技术说明](../home-hero-animation.md)、[双语与 SEO](../bilingual-seo.md)。

## 本次交接

- 当前用户确认：手机 X 390px、桌面 X 650px；白场/形成/旋转前/旋转/旋转后/退场为 **2 / 10 / 2 / 4 / 2 / 5 秒**，合计 **25 秒**。
